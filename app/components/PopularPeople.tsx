...
export default function PopularPeople() {
  ...
  return (
    ...
    {isLoading ? 
        ...
        <>
        <h1 className='px-6 sm:px-10 pt-10 text-[1.2rem] sm:text-2xl font-bold '>Top People</h1>
...
{PopularPeople && PopularPeople.results && PopularPeople.results.map((person: PopularPeopleProps) => (
<li key={person.id}>
...
srcSet={`https://image.tmdb.org/t/p/w220_and_h330_bestv2${person.profile_path} 1x, https://image.tmdb.org/t/p/w300_and_h450_bestv2${person.profile_path} 2x`}
loading='eager'
alt={person.name} />
:
<img  
