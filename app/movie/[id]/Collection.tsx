...
<p className='text-[0.85rem] animate pop xl:text-[1rem] 2xl:text-[1.1rem] pr-2 max-h-[220px] sm:max-h-[320px] scroll-smooth overflow-y-scroll  text-gray-300'>➠ {collection.overview  ? collection.overview : 'No overview available'}</p>
