...
<form className="flex items-center w-full">   
    ...
    <div className="relative w-full active">
        ...
        <input type="text" id="simple-search" className="bg-[hsla(0,0%,94.9%,.14)] placeholder-[#e6e6e6]   text-white text-sm rounded-lg block w-full  p-3  focus:outline-none focus:border-[#e2b616] focus:ring-1 focus:ring-[#e2b616]
    ...
    <button type="submit" className="p-3 ml-2 text-sm font-medium text-white bg-[#e2b616] rounded-lg border border-[#e2b616]">
